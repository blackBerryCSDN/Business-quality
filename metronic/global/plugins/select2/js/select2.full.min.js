		...
		return function() {
				...
				!function(t) {
					...
					function o(e, t) {
						...
						if (e && "." === e.charAt(0))if (t) {
							for (h = h.slice(0, h.length - 1), e = e.split("/"), s = e.length - 1, y.nodeIdCompat && b.test(e[s]) && (e[s] = e[s].replace(b, "")), e = h.concat(e), u = 0; u < e.length; u += 1)if (p = e[u], "." === p)e.splice(u, 1), u -= 1; else if (".." === p) {
					...
					function s(e, n) {
						return function() {
							return h.apply(t, $.call(arguments, 0).concat([e, n]))
						}
					}
			...
			return t.Extend(n, t.Observable), n.prototype.render = function() {
				...
				this.$results.attr("id", i), t.on("results:all", function(e) {
					...
					var e = n.getHighlightedResults(), t = n.$results.find("[aria-selected]"), i = t.index(e), r = i + 1;
					if (!(r >= t.length)) {
						var o = t.eq(r);
						o.trigger("mouseenter");
					...
					var t = n.$results.scrollTop(), i = n.$results.get(0).scrollHeight - n.$results.scrollTop() + e.deltaY, r = e.deltaY > 0 && t - e.deltaY <= 0, o = e.deltaY < 0 && i <= n.$results.height();
					...
					var i = e(this), r = i.data("data");
					return "true" === i.attr("aria-selected") ? void(n.options.get("multiple") ? n.trigger("unselect", {
						originalEvent: t,
						data         : r
					}) : n.trigger("close")) : void n.trigger("select", {originalEvent: t, data: r})
			...
			return t.Extend(i, t.Observable), i.prototype.render = function() {
				...
				var t = this, i = (e.id + "-container", e.id + "-results");
			...
			return n.Extend(i, t), i.prototype.render = function() {
				...
				i.__super__.bind.apply(this, arguments), this.$selection.on("click", function(e) {
					...
					var i = e(this), r = i.parent(), o = r.data("data");
			...
			D.prototype.apply = function(d) {
				...
				if (e.isArray(d.language)) {
					...
					var N = u.loadPath(this.defaults.amdLanguageBase + "en"), Y = new u(d.language);
					Y.extend(N), d.translations = Y
				}
				return d
